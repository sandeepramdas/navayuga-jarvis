...
export function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 bottom-0 z-50 flex flex-col bg-necl-surface border-r border-necl-border overflow-hidden"
    >
      {/* Logo */}
      <div className="h-16 flex items-center border-b border-necl-border px-4 flex-shrink-0">
      ...
      <nav className="flex-1 overflow-y-auto py-3">
        {navItems.map((item, idx) => {
          if ('divider' in item && item.divider) {
            return (
              <div key={`div-${idx}`} className="mx-3 my-2 border-t border-necl-border" />
            )
          }
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : 'text-necl-muted hover:bg-necl-bg hover:text-necl-text',
              )}
            >
      ...
      {/* Footer */}
      <div className="p-3 border-t border-necl-border flex-shrink-0">
